...
namespace _06_Arrays
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //2.4.6.8
            //sarı, lacivert, kırmızı, yeşil, beyaz
            //bursa, istanbul, kayseri
            ...
            //string[] persons = { "ali", "ahmet", "mehmet", "yekta", "cem", "bora" };
            ...
            //string[] customers = { "ali", "bora", "aydın", "murat", "çınar", "kadir" };
            //int index = Array.IndexOf(customers, "murat");
